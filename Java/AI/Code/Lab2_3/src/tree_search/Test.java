...
public class Test {
	public static void main(String[] args) {
		String[] agloList = { "BFS1", "BFS2", "DFS1", "DFS2", "UCS1", "UCS2", "DLS", "DLS_RECURSIVE" };
...
//			nodeH.addEdge(nodeG, 7);
			...
			case "DLS": {
				...
				Node result7 = algo4.execute(nodeS, "G", 2);
				System.out.println(p.printPath(result7));
				break;
			}
			case "DLS_RECURSIVE": {
				DepthLimitedSearch algo5 = new DepthLimitedSearch();

				System.out.println("----------- DLS_RECURSIVE --------------");
				Node result8 = algo5.recursiveDLS(nodeS, "G", 3);
				System.out.println(p.printPath(result8));
				break;
			}
			default:
